...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::get('players/search', [Admin\PlayerController::class, 'search'])->name('players.search');
        ...
        Route::patch('seasons/{season}/teams/{team}/players/{registration}', [Admin\SeasonTeamController::class, 'update'])->name('seasons.teams.players.update');
        ...
        Route::patch('seasons/{season}/squad/{registration}', [Admin\SquadController::class, 'update'])->name('seasons.squad.update');
